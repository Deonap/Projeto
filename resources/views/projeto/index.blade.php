    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
                ...
                <div>
                    <table class="table table-fixed min-w-full" id="projectTable">
                        <thead>
                        ...
                        <tbody>
                            @foreach($projetos as $projeto)
                                <tr role="row" class="h-10 m-auto">
                                    ...
                                    <td class="visible w-fit max-h-10 max-w-[50px] overflow-y-scroll">
                                        <span class="tooltip inline-block w-full">
                                            {{$projeto->obs}}
                                        </span>
                                        <span class="tooltip-content hidden group-hover:inline-block absolute z-10 bg-gray-800 text-white p-2 rounded shadow-md">
                                            {{$projeto->obs}}
                                        </span>
                                    </td>
                                    <?php
